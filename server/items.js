...
const RAW_ITEMS = {
  ...
  // --- Matrix görev kaynakları (vizyon md.23-24, md.28) ---
  // USB/Hard Drive rarity'ye göre ekonomik değer taşır; NPC trader'a satılabilir veya oyuncu trade'inde kullanılabilir.
  ...
  seedpack: { name: 'Seed Pack (100x)', type: 'consumable', category: 'consumable', color: 0xffd93a, rarity: 2 },
};

const ITEMS = {};
for (const [id, def] of Object.entries(RAW_ITEMS)) ITEMS[id] = withDefaults(id, def);

// eleman birleştirme tarifleri — anahtar: eşya id'leri alfabetik sıralı '+' ile birleşik (2 veya 3 girdi olabilir)
const CRAFT_RECIPES = {
  ...
  // metalurji: hammadde cevherleri -> alaşımlar
  ...
  // torna makinesi: alaşımlar -> nihai ürünler
...
const STORE_ITEMS = [
  { id: 'worldlock', price: 150 },
  { id: 'wings_basic', price: 100 },
  { id: 'wings_fire', price: 220 },
  { id: 'wings_crystal', price: 220 },
  { id: 'wings_shadow', price: 260 },
  { id: 'seed_rare', price: 12, qty: 5 },
  { id: 'seed_pepper', price: 4, qty: 5 },
  { id: 'dirt', price: 1, qty: 50 },
  { id: 'elem_dirt', price: 2, qty: 3 },
  { id: 'elem_water', price: 2, qty: 3 },
  { id: 'elem_stone', price: 2, qty: 3 },
  { id: 'elem_lava', price: 3, qty: 3 },
  { id: 'elem_sand', price: 2, qty: 3 },
  { id: 'seedpack', price: 60, qty: 1 },
  { id: 'lathe', price: 300, qty: 1 },
  { id: 'matrix_chair', price: 500, qty: 1 },
  { id: 'shop_stand', price: 400, qty: 1 },
];
